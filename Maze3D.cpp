...
Maze3D::Maze3D(int mazeSize) : Maze(mazeSize) {
   ...
   /* Cell pomCell;
    ...
    std::vector<std::vector<std::vector<Cell>>> maze(this->mazeSize, std::vector< std::vector<Cell> >(this->mazeSize, std::vector< Cell  >(this->mazeSize, Cell())));
    this->maze = maze;
}
...
void Maze3D::init() {
    ...
    while (visited != this->mazeSize * this->mazeSize * this->mazeSize) {
        ...
        std::cout << "[" << stack.top()[0] << ", " << stack.top()[1] << ", " << stack.top()[2] << "]" << s << std::endl;
...
void Maze3D::drawStartFinish() {
    ...
    if (this->playerPosition[1] == 0) {
        sf::CircleShape start(this->cellSize / 3);
        start.setPosition(sf::Vector2f(mazeWidth + this->wallSize + this->cellSize / 6, this->wallSize + this->cellSize / 6));
        start.setFillColor(sf::Color::Red);
        window.draw(start);
    }
    ...
    if (this->playerPosition[0] == 0) {
        sf::CircleShape start(this->cellSize / 3);
        start.setPosition(sf::Vector2f(mazeWidth / 2 + this->wallSize + this->cellSize / 6, mazeWidth + this->wallSize + this->cellSize / 6));
        start.setFillColor(sf::Color::Red);
        window.draw(start);
    }
    ...
    if (this->playerPosition[1] == this->mazeSize - 1) {
        sf::CircleShape finish(this->cellSize / 3);
        finish.setPosition(sf::Vector2f(mazeWidth + this->cellSize * (this->mazeSize - 1) + this->wallSize * (this->mazeSize) + this->cellSize / 6,
                                        this->cellSize * (this->mazeSize - 1) + this->wallSize * (this->mazeSize) + this->cellSize / 6));
    }
    ...
    if (this->playerPosition[0] == this->mazeSize - 1) {
        sf::CircleShape finish(this->cellSize / 3);
        finish.setPosition(sf::Vector2f(mazeWidth / 2 + this->cellSize * (this->mazeSize - 1) + this->wallSize * (this->mazeSize) + this->cellSize / 6,
